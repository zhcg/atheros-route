...
#define WASP_AMBA_BASE		AR7240_APB_BASE+0x00100000
...
#define AR7240_S26_PLL_PWD_OFFSET       AR7240_PLL_BASE+0x24
...
/* Wasp's CPU PLL Configuration Register */
#define WASP_PLL_CONFIG_NINT_SHIFT            10
#define WASP_PLL_CONFIG_NINT_MASK             (0x3f << WASP_PLL_CONFIG_NINT_SHIFT)
#define WASP_PLL_CONFIG_REFDIV_SHIFT          16
#define WASP_PLL_CONFIG_REFDIV_MASK           (0x1f << WASP_PLL_CONFIG_REFDIV_SHIFT)
#define WASP_PLL_CONFIG_OUTDIV_SHIFT          23
#define WASP_PLL_CONFIG_OUTDIV_MASK           (0x7 << WASP_PLL_CONFIG_OUTDIV_SHIFT)
#define WASP_PLL_CONFIG_PLLPWD_SHIFT          30
#define WASP_PLL_CONFIG_PLLPWD_MASK           (0x1 << WASP_PLL_CONFIG_PLLPWD_SHIFT)
#define WASP_PLL_CONFIG_UPDATING_SHIFT        31
#define WASP_PLL_CONFIG_UPDATING_MASK         (0x1 << WASP_PLL_CONFIG_UPDATING_SHIFT)
/* Wasp's CPU PLL Configuration 2 Register */
#define WASP_PLL_CONFIG2_SETTLE_TIME_SHIFT    0
#define WASP_PLL_CONFIG2_SETTLE_TIME_MASK     (0xfff << WASP_PLL_CONFIG2_SETTLE_TIME_SHIFT)
/* Wasp's CPU Clock Control Register */
#define WASP_CLOCK_CONTROL_BYPASS_SHIFT       2
#define WASP_CLOCK_CONTROL_BYPASS_MASK        (0x1 << WASP_CLOCK_CONTROL_BYPASS_SHIFT)
#define WASP_CLOCK_CONTROL_CPU_POST_DIV_SHIFT 5
#define WASP_CLOCK_CONTROL_CPU_POST_DIV_MASK  (0x3 << WASP_CLOCK_CONTROL_CPU_POST_DIV_SHIFT)
#define WASP_CLOCK_CONTROL_DDR_POST_DIV_SFIFT 10
#define WASP_CLOCK_CONTROL_DDR_POST_DIV_MASK  (0x3 << WASP_CLOCK_CONTROL_DDR_POST_DIV_SFIFT)
#define WASP_CLOCK_CONTROL_AHB_POST_DIV_SFIFT 15
#define WASP_CLOCK_CONTROL_AHB_POST_DIV_MASK  (0x3 << WASP_CLOCK_CONTROL_AHB_POST_DIV_SFIFT)
...
/* PLL S26 power down mask */
#define WASP_S26_CORE_PLL_PWD_SHIFT           3
#define WASP_S26_CORE_PLL_PWD_MASK            (0x1 << WASP_S26_CORE_PLL_PWD_SHIFT)
#define WASP_S26_ENABLE_CORE_BIAS_SHIFT       4
#define WASP_S26_ENABLE_CORE_BIAS_MASK        (0x1 << WASP_S26_ENABLE_CORE_BIAS_SHIFT)
...
#define AR7240_GPIO_EXT_FUNC            AR7240_GPIO_BASE+0x30
 ...
 * Reset block
 */
#define AR7240_GENERAL_TMR		(AR7240_RESET_BASE + 0x00)
#define AR7240_GENERAL_TMR_RELOAD	(AR7240_RESET_BASE + 0x04)
#define AR7240_WATCHDOG_TMR_CONTROL	(AR7240_RESET_BASE + 0x08)
#define AR7240_WATCHDOG_TMR		(AR7240_RESET_BASE + 0x0c)
...
#define WASP_BOOTSTRAP_STATUS		(AR7240_RESET_BASE + 0xac) /* Wasp's bootstrap register */
...
/*
 * Ensure is aligned with enum hostif_s define in fwd.h
 *
 * For S27 boot, we have an additional boot strap pin @gpio_4.
 * This will be reflected in bit 20 of the bootstrap register.
 * Instead of multiple bit shifts, just ignoring the middle
 * two bits...
 */
#define WASP_BOOT_TYPE(a)		(((a) >> 16) & 0x23)

#define WASP_RAM_TYPE(a)		((a) & 0x3)
#define WASP_RAM_SDRAM			0	/* SDRAM */
#define WASP_RAM_DDR1			2	/* DDR1 */
#define WASP_RAM_DDR2			3	/* DDR2 */

#define WASP_REF_CLK_25			(1 << 4)	/* 0 - 25MHz	1 - 40 MHz */
#define WASP_DDR_WIDTH_32		(1 << 3)
...
#define AR7240_RESET_GE1_PHY                (1 << 12) /* Switch analog reset */
#define AR7240_RESET_WLAN                   (1 << 11)
#define AR7240_RESET_PCIE_PHY_SERIAL        (1 << 10)
#define AR7240_RESET_GE0_MAC                (1 << 9)
#define AR7240_RESET_GE0_MDIO               (1 << 22)
#define AR7240_RESET_GE0_PHY                (1 << 8) /* Switch digital reset, not exactly GE0 */
