...
int serial_init(void)
{
    ...
    /* The formulas given by RTL codes
        1) (128*1024)/(UartClockStep) = #ClockSteps
        2) (10^9)/BaudeRate = #ClockSteps*ref_clk_period(ns)*(UartClockScale + 1)
       Because there are 3 variables in 2 formulas, datasheet provides the following simplified formulas
        1) clk_scale = Integral Part of {(serial_clk*1310)/(131072*baudrate)}
        2) clk_step = Round off {((131072*baudrate)/serial_clk)*(clk_scale+1))
       Because Hornet MIPS CPU doesn't support floating point, hard-coded values are used
        1) XTAL 25MHz
           115200 : clk_scale   2, clk_step 1812
            57600 : clk_scale   4, clk_step 1510
            38400 : clk_scale   6, clk_step 1409
            19200 : clk_scale  13, clk_step 1409
             9600 : clk_scale  26, clk_step 1359
             4800 : clk_scale  52, clk_step 1334
             2400 : clk_scale 104, clk_step 1321
             1200 : clk_scale 208, clk_step 1315
              600 : clk_scale 832, clk_step 1310 cannot work because max. value of clk_scale is 0xff            
        2) XTAL 40MHz
           115200 : clk_scale   3, clk_step 1510
            57600 : clk_scale   6, clk_step 1321
            38400 : clk_scale  10, clk_step 1384
            19200 : clk_scale  20, clk_step 1321
             9600 : clk_scale  41, clk_step 1321
             4800 : clk_scale  83, clk_step 1321
             2400 : clk_scale 166, clk_step 1313
             1200 : clk_scale 333, clk_step 1313 cannot work because max. value of clk_scale is 0xff
              600 : clk_scale 666, clk_step 1311 cannot work because max. value of clk_scale is 0xff             
     */     
    if (rdata) { // 40 MHz clock is taken as UART clock
        baudRateDivisor = 3;  
        clock_step      = 1510;	
    }      
    else { // 25 MHz clock is taken as UART clock
        baudRateDivisor = 2;  
        clock_step      = 1812;        
    }       
#else
