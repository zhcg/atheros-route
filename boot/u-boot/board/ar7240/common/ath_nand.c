...
#define ATH_NF_FBBM_SIZE	4	// Factory Bad Block Marker
#define ATH_NF_JFFS2_CM_SIZE	16	// JFFS2 Clean Marker
...
ath_nand_ecc_init(struct mtd_info *mtd)
{
	...
	if (is_small_block_device(sc)) {
		...
		sc->ecc_offset = mtd->writesize + ATH_NF_FBBM_SIZE +
					ATH_NF_JFFS2_CM_SIZE;
	}
#else
	sc->ecc_offset = 0;
#endif
