...
/*support for WAPI*/
    ...
    u_int64_t       wk_keyrscdropped[IEEE80211_TID_SIZE];  /* key receive sequence dropped counter */
    u_int8_t       wk_keyrscdroppedcnt[IEEE80211_TID_SIZE];  /* key receive sequence dropped counter */
    u_int64_t       wk_keyrscglobal;  /* key receive sequence dropped counter */
    u_int8_t       wk_keyrscupdate[IEEE80211_TID_SIZE];/* key receive sequence dropped counter */
