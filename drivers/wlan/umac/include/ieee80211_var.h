...
#define IEEE80211_MAX_RESMGR_EVENT_HANDLERS     8 
...
#define tdls_recv_mgmt            ic_tdls->recv_mgmt
    ...
    u_int8_t                         ic_default_rx_ant;
#endif    
#if UMAC_SUPPORT_SMARTANTENNA         /* iwpriv variables*/ 
    struct ieee80211_smartantenna_params  *ic_smartantennaparams;
    u_int8_t                         ic_smartantenna_init_done;

    /*
     * dedicated worker thread for smart antenna module
     */
    
    adf_os_workqueue_t *ic_smart_workqueue;
    adf_os_delayed_work_t smartant_task;
    os_timer_t  ic_smartant_retrain_timer;
    ...
    struct ieee80211_node   *(*ic_node_alloc)(struct ieee80211_node_table *, struct ieee80211vap *, bool tmpnode);
...
#ifdef ATHR_RNWF
    int                     (*ic_rmgetcounters)(struct ieee80211com *ic, struct ath_mib_cycle_cnts *pCnts);
    ...
    u_int32_t               (*ic_get_maxphyrate)(struct ieee80211com *ic, struct ieee80211_node *ni,uint32_t shortgi);
...
#define IEEE80211_IS_TAPMON_ENABLED(__ic) 0
    ...
    u_int16_t   (*ic_dfs_in_cac)(struct ieee80211com *ic);
    ...
    void        (*ic_set_selected_smantennas) (struct ieee80211_node *ni, int antenna, int rateset);
    ...
    u_int32_t   (*ic_get_txbuf_used) (struct ieee80211com *ic, int ac);
...
#endif   
    void        (*ic_scan_enable_txq)(struct ieee80211com *); 
...
#define IEEE80211_FEXT_WDSLEGACY           0x00000200    /* CONF: legacy WDS operation */
...
#define IEEE80211_VAP_XRUPDATE_ENABLE(_v)           ((_v)->iv_flags |= IEEE80211_F_XRUPDATE)
#define IEEE80211_VAP_XRUPDATE_DISABLE(_v)          ((_v)->iv_flags &= ~IEEE80211_F_XRUPDATE)
#define IEEE80211_VAP_IS_XRUPDATE_ENABLED(_v)       ((_v)->iv_flags & IEEE80211_F_XRUPDATE)
...
#define IEEE80211_DPRINTF_IC(_ic, _verbo, _m, _fmt, ...) do {           \
        if (((_ic)->ic_debug & (_m)) && (_verbo <= IEEE80211_VERBOSE_LOUD)) {         \
