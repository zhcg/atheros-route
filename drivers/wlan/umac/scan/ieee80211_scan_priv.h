...
#define ieee80211_scan_scheduler_set_priority(_ssc, _vap, _req, _id, _prio)          ieee80211_scan_set_priority(_ssc, _req, _id, _prio)

#define ieee80211_scan_scheduler_set_forced_flag(_ssc, _vap, _req, _id, _flag)       ieee80211_scan_set_forced_flag(_ssc, _req, _id, _flag)
