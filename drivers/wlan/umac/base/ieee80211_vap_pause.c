...
static void ieee80211_vap_power_pause_event_handler (ieee80211_sta_power_t powersta, ieee80211_sta_power_event *event, void *arg);
...
{
    ieee80211_sta_power_register_event_handler(vap->iv_pwrsave_sta,ieee80211_vap_power_pause_event_handler,vap);
}

void ieee80211_vap_pause_vdetach(struct ieee80211com *ic,ieee80211_vap_t vap) 
{
    ieee80211_resmgr_unregister_notification_handler(ic->ic_resmgr, ieee80211_vap_resmgr_notification_handler,vap);
    (void)ieee80211_sta_power_unregister_event_handler(vap->iv_pwrsave_sta,ieee80211_vap_power_pause_event_handler,vap);
...
int ieee80211_vap_pause(ieee80211_vap_t vap, u_int16_t reqid )
{
    ...
    if (vap->iv_opmode  == IEEE80211_M_STA) {
        if (ieee80211_sta_power_pause(vap->iv_pwrsave_sta, IEEE80211_MAX_PAUSE_TIMEOUT) != EOK) {
