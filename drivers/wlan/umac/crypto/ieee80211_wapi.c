...
#define MCAST_SUITE_POLICY 	BIT(0)
#define UCAST_SUITE_POLICY 	BIT(1)
#define KEYMGT_ALGS_POLICY	(BIT(2)|BIT(3))
#define PREAUTH_POLICY		BIT(4)
	...
	if(	((value & MCAST_SUITE_POLICY) == 0) ||
		((value & UCAST_SUITE_POLICY) == 0) ||
		((value & KEYMGT_ALGS_POLICY) == 0))
	{
		return -EINVAL;
	}
	/*
	...
	return 0;
#undef MCAST_SUITE_POLICY 
#undef UCAST_SUITE_POLICY 
#undef KEYMGT_ALGS_POLICY
#undef PREAUTH_POLICY	
}
