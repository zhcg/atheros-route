...
typedef struct adf_net_wcmd_scan_result{
    ...
    a_uint8_t   isr_wpa_ie[ADF_NET_WCMD_IE_MAXLEN];
    a_uint8_t   isr_wme_ie[ADF_NET_WCMD_IE_MAXLEN];
    a_uint8_t   isr_ath_ie[ADF_NET_WCMD_IE_MAXLEN]; 
...
typedef struct adf_net_wcmd_11n_stats {
    ...
    a_uint32_t   txaggr_badtid; /**< tx aggr: Bad TID */
