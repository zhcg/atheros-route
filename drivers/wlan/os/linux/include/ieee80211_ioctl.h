...
enum {
    ...
    IEEE80211_PARAM_CLR_APPOPT_IE       = 178,  /* Clear Cached App/OptIE */
    IEEE80211_PARAM_SW_WOW              = 179,  /* wow by sw */
#if UMAC_SUPPORT_WDS
    ...
    IEEE80211_PARAM_RXBUF_LIFETIME   = 194, /* lifetime of reycled rx buffers */
#ifdef __CARRIER_PLATFORM__
    IEEE80211_PARAM_PLTFRM_PRIVATE = 195, /* platfrom's private ioctl*/
#endif
#ifdef CONFIG_RCPI        
    IEEE80211_PARAM_TDLS_RCPI_HI     = 196,    /* RCPI params: hi,lo threshold and margin */
    IEEE80211_PARAM_TDLS_RCPI_LOW    = 197,    /* RCPI params: hi,lo threshold and margin */
    IEEE80211_PARAM_TDLS_RCPI_MARGIN = 198,    /* RCPI params: hi,lo threshold and margin */
    IEEE80211_PARAM_TDLS_SET_RCPI    = 199,    /* RCPI params: set hi,lo threshold and margin */
    IEEE80211_PARAM_TDLS_GET_RCPI    = 200,    /* RCPI params: get hi,lo threshold and margin */
#endif    
#if UMAC_SUPPORT_VI_DBG
    /* Support for Video Debug */
    IEEE80211_PARAM_DBG_CFG            = 201,
    IEEE80211_PARAM_DBG_NUM_STREAMS    = 202,
    IEEE80211_PARAM_STREAM_NUM         = 203,
    IEEE80211_PARAM_DBG_NUM_MARKERS    = 204,
    IEEE80211_PARAM_MARKER_NUM         = 205,
    IEEE80211_PARAM_MARKER_OFFSET_SIZE = 206,
    IEEE80211_PARAM_MARKER_MATCH       = 207,
    IEEE80211_PARAM_RXSEQ_OFFSET_SIZE  = 208,
    IEEE80211_PARAM_RX_SEQ_RSHIFT      = 209,
    IEEE80211_PARAM_RX_SEQ_MAX         = 210,
    IEEE80211_PARAM_RX_SEQ_DROP        = 211,
    IEEE80211_PARAM_TIME_OFFSET_SIZE   = 212,
    IEEE80211_PARAM_RESTART            = 213,
    IEEE80211_PARAM_RXDROP_STATUS      = 214,
#endif 
#if ATH_SUPPORT_IBSS_DFS
    IEEE80211_PARAM_IBSS_DFS_PARAM     = 215,
#endif
    IEEE80211_PARAM_MAXSTA              = 216, 
#if ATH_SUPPORT_IBSS_NETLINK_NOTIFICATION
    IEEE80211_PARAM_IBSS_SET_RSSI_CLASS     = 217,	
    IEEE80211_PARAM_IBSS_START_RSSI_MONITOR = 218,
    IEEE80211_PARAM_IBSS_RSSI_HYSTERESIS    = 219,
#endif
#ifdef ATH_SUPPORT_TxBF
    IEEE80211_PARAM_TXBF_AUTO_CVUPDATE = 220,       /* Auto CV update enable*/
    IEEE80211_PARAM_TXBF_CVUPDATE_PER = 221,        /* per theshold to initial CV update*/
#endif
#if UMAC_SUPPORT_SMARTANTENNA
    IEEE80211_PARAM_SMARTANT_TRAIN_MODE   = 222,    /* smart antenna training mode implicit or explicit*/
    IEEE80211_PARAM_SMARTANT_TRAIN_TYPE   = 223,    /* smart antenna train type frame base or protocol based */
    IEEE80211_PARAM_SMARTANT_PKT_LEN      = 224,    /* packet length of the training packet */
    IEEE80211_PARAM_SMARTANT_NUM_PKTS     = 225,    /* number of packets need to send for training */
    IEEE80211_PARAM_SMARTANT_TRAIN_START  = 226,    /* start smart antenna training */
    IEEE80211_PARAM_SMARTANT_NUM_ITR      = 227,    /* number of iterations needed for training */
#endif    
#if UMAC_SUPPORT_INTERNALANTENNA    
    IEEE80211_PARAM_SMARTANT_CURRENT_ANTENNA = 228, /* current smart antenna used for TX */
    IEEE80211_PARAM_SMARTANT_DEFAULT_ANTENNA = 229, /* default antenna for RX */
#endif    
#if UMAC_SUPPORT_SMARTANTENNA    
    IEEE80211_PARAM_SMARTANT_AUTOMATION = 233,      /* Smart antenna automation mode */
    IEEE80211_PARAM_SMARTANT_RETRAIN = 234,         /* Smart antenna retrain enable/disable */
#endif    
    IEEE80211_PARAM_SCAN_BAND = 230,                /* only scan channels of requested band */
#if ATH_SUPPORT_FLOWMAC_MODULE
    IEEE80211_PARAM_FLOWMAC            = 231, /* flowmac enable/disable ath0*/
#endif
    IEEE80211_PARAM_MFP_TEST    = 232,
#if UMAC_SUPPORT_IBSS    
    IEEE80211_PARAM_IBSS_CREATE_DISABLE = 235,      /* if set, it prevents IBSS creation */
#endif
    IEEE80211_PARAM_WEATHER_RADAR_CHANNEL = 236, /* weather radar channel selection is bypassed */
#if ATH_SUPPORT_WPA_SUPPLICANT_CHECK_TIME    
    IEEE80211_PARAM_REJOINT_ATTEMP_TIME = 237, /* Set the Rejoint time */
#endif   
    IEEE80211_PARAM_WEP_KEYCACHE          = 238,/* wepkeys mustbe in first fourslots in Keycache*/
    IEEE80211_PARAM_GET_ACS               = 239,/* to get status of acs */
    IEEE80211_PARAM_GET_CAC               = 240,/* to get status of CAC period */
};
/*
