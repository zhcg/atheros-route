...
struct ath_bt_info {
    ...
    u_int32_t           bt_stomping : 1,    /* BT is being stomped */
                        ...
                        activeProfile:4,    /* If a PAN profile exists */
    ...
    u_int16_t           lowACKDisableCnt;
    u_int16_t           lowACKEnableCnt;
...
#define ATH_COEX_RSSI_PROFILE_CNT   20

/* Force stomp */
#define BT_COEX_FORCE_STOMP_ASSOC       0x01
#define BT_COEX_FORCE_STOMP_RX_TRAFFIC  0x02
#define BT_COEX_FORCE_STOMP_CHECK_TIME  100     // 100 ms
...
#define BT_COEX_IS_11G_MODE(_sc) (((_sc)->sc_curchan.channelFlags & CHANNEL_G) == CHANNEL_G)
