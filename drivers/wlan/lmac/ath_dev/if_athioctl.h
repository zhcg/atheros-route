...
typedef enum {
    ...
    ATH_PARAM_AGGR_BURST                =76,
    ATH_PARAM_AGGR_BURST_DURATION       =77,
#endif
#if UMAC_SUPPORT_INTERNALANTENNA
    ATH_PARAM_SMARTANTENNA              = 78,
#endif    
    ...
    ATH_PARAM_DCS                       =82,
    ATH_PARAM_DCS_COCH                  =83,
    ATH_PARAM_DCS_TXERR                 =84,
#endif
   ATH_PARAM_RTS_CTS_RATE   		   =85,
#if ATH_SUPPORT_RX_PROC_QUOTA   
   ATH_PARAM_CNTRX_NUM                 =86,
#endif   
