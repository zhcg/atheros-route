...
int ath_htc_process_uapsd_trigger(ath_dev_t dev, ath_node_t node, u_int8_t maxsp, u_int8_t ac, u_int8_t flush, u_int8_t maxqdepth);
...
#define ath_wmi_beacon(dev, beaconPendingCount)
