...
#if UMAC_SUPPORT_SMARTANTENNA
#define MAX_SM_RATES_PERSET 7
struct ath_ratetoindex {     /* Valid Rate Index table from RC module */
    u_int8_t ratecode;
    u_int8_t rateindex;
};  
    
struct ath_smartant_rateset {
    u_int8_t num_of_rates;
    struct ath_ratetoindex rates[MAX_SM_RATES_PERSET];  /* Maximum 7 rates per set*/
