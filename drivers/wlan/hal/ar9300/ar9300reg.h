...
/* MAC Indicates the size of High and Low priority RxDP FIFOs */
...
enum {
     ...
     */
    AR_INTR_SYNC_DEF_NO_HOST1_PERR      = (AR_INTR_SYNC_HOST1_FATAL         |
    ...
    AR_INTR_SYNC_DEFAULT                = (AR_INTR_SYNC_DEF_NO_HOST1_PERR   |
...
#define AR93XX_NUM_GPIO                  17 // 0 to 16

/* GPIO Output Register */
#define AR_GPIO_OUT_VAL                  0x0001FFFF
#define AR_GPIO_OUT_VAL_S                0

/* GPIO Input Register */
#define AR_GPIO_IN_VAL                   0x0001FFFF
...
#define AR_GPIO_OUTPUT_MUX_AS_SMARTANT_CTRL0     9
#define AR_GPIO_OUTPUT_MUX_AS_SMARTANT_CTRL1     10
#define AR_GPIO_OUTPUT_MUX_AS_SMARTANT_CTRL2     11
...
/* phy_errs causing eifs delay */
#define AR_PHY_ERR_EIFS_MASK   AR_MAC_PCU_OFFSET(MAC_PCU_PHY_ERROR_EIFS_MASK)
...
#define AR_WOW_KA_DATA_WORD0        AR_WOW_TXBUF(12)
#define AR_WOW_KA_DATA_WORD1        AR_WOW_TXBUF(13)
#define AR_WOW_KA_DATA_WORD2        AR_WOW_TXBUF(14)
#define AR_WOW_KA_DATA_WORD3        AR_WOW_TXBUF(15)
#define AR_WOW_KA_DATA_WORD4        AR_WOW_TXBUF(16)
#define AR_WOW_KA_DATA_WORD5        AR_WOW_TXBUF(17)
...
#ifdef AR9300_EMULATION
#define AR_SREV_VERSION_OSPREY 0xC0
#define AR_SREV_VERSION_AR9580 0xC0
#else
...
#define AR_SREV_SOC(_ah) \
    (AR_SREV_HORNET(_ah) || AR_SREV_POSEIDON(_ah) || AR_SREV_WASP(_ah))
