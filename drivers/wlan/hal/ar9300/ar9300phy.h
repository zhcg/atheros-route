...
#define AR_PHY_MRC_CCK_CTRL         AR_AGC_OFFSET(overlay_0x9fd0.Osprey.BB_mrc_cck_ctrl)
...
#define AR_PHY_TX_IQCAL_CONTROL_1   AR_SM_OFFSET(overlay_0xa580.Osprey.BB_txiqcal_control_1)
#define AR_PHY_TX_IQCAL_START       AR_SM_OFFSET(overlay_0xa580.Osprey.BB_txiqcal_start)
#define AR_PHY_TX_IQCAL_STATUS_B0   AR_SM_OFFSET(overlay_0xa580.Osprey.BB_txiqcal_status_b0)
...
#define AR_PHY_TX_IQCAL_CONTROL_1_POSEIDON   AR_SM_OFFSET(overlay_0xa580.Poseidon.BB_txiqcal_control_1)
#define AR_PHY_TX_IQCAL_START_POSEIDON       AR_SM_OFFSET(overlay_0xa580.Poseidon.BB_txiqcal_control_0)
#define AR_PHY_TX_IQCAL_STATUS_B0_POSEIDON   AR_SM_OFFSET(overlay_0xa580.Poseidon.BB_txiqcal_status_b0)
...
#define AR_PHY_CCA_1                 AR_AGC1_OFFSET(overlay_0xae1c.Osprey.BB_cca_b1)
...
#define AR_PHY_PDADC_TAB_1       AR_SM1_OFFSET(BB_pdadc_tab_b1)
...
#define AR_PHY_PDADC_TAB_2       AR_SM2_OFFSET(BB_pdadc_tab_b2)
...
#define RCVD_ERR_MASK                        0x000f
#define BAD_TLP_ERR_MASK                     0x00f0
#define BAD_DLLP_ERR_MASK                    0x0f00

#define RPLY_TO_ERR_MASK                     0x000f
#define RPLY_NUM_RO_ERR_MASK                 0x00f0
