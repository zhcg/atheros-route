...
#define RADIOTAP_MCS_FLAGS_SHORT_GI     0x02

#ifdef WIN32
#pragma pack(push, ppi_structures, 1)
...
struct ah_ppi_pfield_common {
    ...
    u_int16_t               common_chanFreq;
    u_int16_t               common_chanFlags;
    u_int8_t                common_fhssHopset;
    u_int8_t                common_fhssPattern;
    u_int8_t                common_dBmAntSignal;
...
struct ah_ppi_pfield_macphy_extensions {
    ...
    u_int32_t               macphy_ampduId;
    u_int8_t                macphy_delimiters;
    u_int8_t                macphy_mcs;
    u_int8_t                macphy_numStreams;
    u_int8_t                macphy_rssiCombined;
    u_int8_t                macphy_rssiAnt0Ctl;
    u_int8_t                macphy_rssiAnt1Ctl;
    u_int8_t                macphy_rssiAnt2Ctl;
    u_int8_t                macphy_rssiAnt3Ctl;
    u_int8_t                macphy_rssiAnt0Ext;
    u_int8_t                macphy_rssiAnt1Ext;
    u_int8_t                macphy_rssiAnt2Ext;
    u_int8_t                macphy_rssiAnt3Ext;
    u_int16_t               macphy_chanFreq;
    u_int16_t               macphy_chanFlags;
    u_int8_t                macphy_ant0Signal;
    u_int8_t                macphy_ant0Noise;
    u_int8_t                macphy_ant1Signal;
    u_int8_t                macphy_ant1Noise;
    u_int8_t                macphy_ant2Signal;
    u_int8_t                macphy_ant2Noise;
...
#ifdef WIN32
#pragma pack(pop, ppi_structures)
#endif // WIN32
