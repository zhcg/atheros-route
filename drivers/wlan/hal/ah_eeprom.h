...
#define	AR_EEPROM_VER5_4	0x5004	/* Adds spur mitigation table */
...
typedef enum {
    USE_ABOLT,                  /* Let ABOLT setting control enable/disable */
    DISABLE_TURBO_G,            /* Unconditionally disable turbo g */
    AUTO                        /* Let eeprom and ABOLT setting control it */
} CONTROL_TURBO_G;
#endif
...
#define	MIN_RATE_POWER	 1    /* 0.5 dBm */
