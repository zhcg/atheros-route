...
/*--ar5416ConfigureFftPeriod--
 * Sets the FFT period inVal 
 */
void ar5416ConfigFftPeriod(struct ath_hal *ah, u_int32_t inVal)
{
    u_int32_t val;
...
/*--ar5416ConfigureScanPeriod--
 * Sets the scan period inVal
 */
void ar5416ConfigScanPeriod(struct ath_hal *ah, u_int32_t inVal)
{
    u_int32_t val;
    val = OS_REG_READ(ah, AR_PHY_SPECTRAL_SCAN);
