...
static inline void ar5416InitRateTxPowerCCK(struct ath_hal *ah,
       HAL_RATE_TABLE *rt, int16_t ratesArray[], u_int8_t chainmask);
static inline void ar5416InitRateTxPowerOFDM(struct ath_hal* ah,
       HAL_RATE_TABLE *rt, int16_t ratesArray[], int rt_offset,
       u_int8_t chainmask);
static inline void ar5416InitRateTxPowerHT(struct ath_hal *ah,
       HAL_RATE_TABLE *rt, HAL_BOOL is40, int ht40Correction,
...
static inline void
ar5416InitRateTxPowerCCK(struct ath_hal *ah, HAL_RATE_TABLE *rt,
...
static inline void
ar5416InitRateTxPowerOFDM(struct ath_hal *ah, HAL_RATE_TABLE *rt,
 ...
 */
static inline void
ar5416InitRateTxPowerHT(struct ath_hal *ah, HAL_RATE_TABLE *rt, HAL_BOOL is40,
