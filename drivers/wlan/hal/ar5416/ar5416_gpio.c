...
void ar7010RegisterGpio(struct ath_hal *ah)
{
    ...
    ahp->ah_priv.priv.h.ah_gpioCfgInput  = ar7010GpioCfgInput;
    ahp->ah_priv.priv.h.ah_gpioCfgOutput = ar7010GpioCfgOutput;
    ahp->ah_priv.priv.h.ah_gpioGet       = ar7010GpioGet;
    ahp->ah_priv.priv.h.ah_gpioSet       = ar7010GpioSet;
    ahp->ah_priv.priv.h.ah_gpioSetIntr   = ar7010GpioSetIntr;
}
 ...
 */
void
ar7010GpioSetIntr(struct ath_hal *ah, u_int gpio, u_int32_t ilevel)
{
    /* TODO: Magpie doesn't indicate interrupt event now? */    
}
#endif
