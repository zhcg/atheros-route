...
#define AR_SREV_OWL(_ah) \
    ((AH_PRIVATE((_ah))->ah_macVersion == AR_SREV_VERSION_OWL_PCI) || \
     (AH_PRIVATE((_ah))->ah_macVersion == AR_SREV_VERSION_OWL_PCIE))
#define AR_SREV_OWL_10(_ah) \
    (((_ah)->ah_macVersion == AR_SREV_VERSION_OWL_PCI) || \
...
#define AR_SREV_OWL_20_OR_LATER(_ah) \
    ((AH_PRIVATE((_ah))->ah_macVersion >= AR_SREV_VERSION_SOWL) || \
...
#define AR_SREV_SOWL_11(_ah) \
    (AR_SREV_SOWL(_ah) && \
     (AH_PRIVATE((_ah))->ah_macRev == AR_SREV_REVISION_SOWL_11))
#else
/*
...
#define AR_SREV_KIWI(_ah) \
    ((AH_PRIVATE((_ah))->ah_macVersion == AR_SREV_VERSION_KIWI))
    ...
    #define AR_SREV_KIWI_10(_ah) \
        ((AH_PRIVATE((_ah))->ah_macVersion == AR_SREV_VERSION_KIWI) && \
         (AH_PRIVATE((_ah))->ah_macRev == AR_SREV_REVISION_KIWI_10))
#else
...
#define AR_SREV_KIWI_11(_ah) \
    ((AH_PRIVATE((_ah))->ah_macVersion == AR_SREV_VERSION_KIWI) && \
     (AH_PRIVATE((_ah))->ah_macRev == AR_SREV_REVISION_KIWI_11))
#define AR_SREV_KIWI_12(_ah) \
    ((AH_PRIVATE((_ah))->ah_macVersion == AR_SREV_VERSION_KIWI) && \
     (AH_PRIVATE((_ah))->ah_macRev == AR_SREV_REVISION_KIWI_12))
#else
/*
...
#define AR_SREV_KIWI_13_OR_LATER(_ah) \
    ((AH_PRIVATE((_ah))->ah_macVersion > AR_SREV_VERSION_KIWI) || \
     ((AH_PRIVATE((_ah))->ah_macVersion == AR_SREV_VERSION_KIWI) && \
      (AH_PRIVATE((_ah))->ah_macRev >= AR_SREV_REVISION_KIWI_13)))
...
#define AR_SREV_KITE(_ah) \
    ((AH_PRIVATE((_ah))->ah_macVersion == AR_SREV_VERSION_KITE))
    ...
    #define AR_SREV_KITE_11(_ah) \
      (AR_SREV_KITE(_ah) && \
       (AH_PRIVATE((_ah))->ah_macRev == AR_SREV_REVISION_KITE_11))
#else
...
#define AR_SREV_KITE_12(_ah) \
    (AR_SREV_KITE(_ah) && \
     (AH_PRIVATE((_ah))->ah_macRev == AR_SREV_REVISION_KITE_12))
#else
/*
...
#define AR_SREV_K2(_ah) \
    ((AH_PRIVATE((_ah))->ah_macVersion == AR_SREV_VERSION_K2))
#define AR_SREV_K2_10(_ah) \
    (AR_SREV_K2(_ah) && \
     (AH_PRIVATE((_ah))->ah_macRev == AR_SREV_REVISION_K2_10))
#define AR_SREV_K2_11(_ah) \
    (AR_SREV_K2(_ah) && \
     (AH_PRIVATE((_ah))->ah_macRev == AR_SREV_REVISION_K2_11))
#else
/*
