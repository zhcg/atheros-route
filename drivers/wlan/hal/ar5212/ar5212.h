...
#define AR5212_CHANNEL_SWITCH_TIME_USEC  4000
...
extern  HAL_BOOL ar5212PrintKeyCache(struct ath_hal *ah);
...
extern	u_int64_t ar5212GetTsf2_64(struct ath_hal *ah);
...
extern  HAL_BOOL ar5212WowEnable(struct ath_hal *ah, u_int32_t patternEnable, u_int32_t timeoutInSeconds, int clearbssid);
#endif
...
#ifdef _WIN64
extern  void ar5212GetDescLinkPtr(struct ath_hal *, void *ds, u_int32_t __unaligned **link);
#else
...
#endif
extern  HAL_BOOL ar5212FillKeyTxDesc(struct ath_hal *ah, void *, HAL_KEY_TYPE);
...
extern void ar5212Set11nTxDesc(struct ath_hal *ah, void *ds, u_int pktLen, HAL_PKT_TYPE type, u_int txPower, u_int keyIx, HAL_KEY_TYPE keyType, u_int flags);
extern void ar5212Set11nRateScenario(struct ath_hal *ah, void *ds, void *lastds, u_int durUpdateEn, u_int rtsctsRate, u_int rtsctsDuration, HAL_11N_RATE_SERIES series[], u_int nseries, u_int flags, u_int32_t smartAntenna);
extern void ar5212Set11nAggrFirst(struct ath_hal *ah, void *ds, u_int aggrLen);
extern void ar5212Set11nAggrMiddle(struct ath_hal *ah, void *ds, u_int numDelims);
...
extern void ar5212Set11nBurstDuration(struct ath_hal *ah, void *ds, u_int burstDuration);
...
extern int ar5212GetNumAntCfg(struct ath_hal *ah);
...
extern void ar5212GetVowStats(struct ath_hal *, HAL_VOWSTATS*);
#ifdef ATH_CCX
