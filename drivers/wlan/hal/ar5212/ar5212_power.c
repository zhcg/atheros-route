...
void
ar5212WowApplyPattern(struct ath_hal *ah, u_int8_t *pAthPattern, u_int8_t *pAthMask, int32_t pattern_count, u_int32_t athPatternLen)
{
    int i;
    u_int32_t    reg_pat[] = {
...
HAL_BOOL
ar5212WowEnable(struct ath_hal *ah, u_int32_t patternEnable, u_int32_t timeoutInSeconds, int clearbssid)
{
    ...
    if (patternEnable & AR_WOW_MAGIC_PATTERN_EN) {
...
u_int32_t
ar5212WowWakeUp(struct ath_hal *ah)
{
