...
/*** NMIWar ***/
/* For Eagle only */
#define AR_COMPBUF_CFG                  0x4068 /* On-chip compression buffer configuration register */
#define AR_COMPBUF_DISABLE              0x10   /* On-chip compression buffer disable */
...
/* WOW Registers */
/* Host WoW registers and values */
#define AR_WOW_HOST_PCIE_PMC            0x4068  /* Host wow Register */

#define AR_WOW_HOST_PME_ENABLE          0x0010  /* PME enable bit */
#define AR_WOW_AUX_PWR_DET              0x0020  /* Auxilary power detect */
#define AR_WOW_PME_CLEAR                0x0040  /* Clear the wow events */
#define AR_WOW_PWR_STATE_MASK_D0        0x0080
#define AR_WOW_PWR_STATE_MASK_D1        0x0100
#define AR_WOW_PWR_STATE_MASK_D2        0x0200
#define AR_WOW_PWR_STATE_MASK_D3        0x0400

#define AR_PCIE_WAEN                    0x407C /* PCIe workaround enable */
...
#define AR_TSFOOR_THRESHOLD             0x813c  /* TSF out of range threshold */

#define AR_PHY_ERR_EIFS_MASK            0x8144  /* phy_errs cause eifs delay */
...
/* Mac WoW registers */
#define AR_WOW_BACK_OFF_SHIFT           0x8148
#define AR_WOW_AR_INTR_ENABLE           0x814c
#define AR_WOW_MAGIC_ENABLE             0x8150
#define AR_WOW_PATTERN_ENABLE           0x8154
#define AR_WOW_AIFS_CNT                 0x8158
#define AR_WOW_SLOT_CNT                 0x815c
#define AR_WOW_KEEP_ALIVE_CNT           0x8160
#define AR_WOW_BEACON_FAIL_ENABLE       0x8164
#define AR_WOW_BEACON_TIMEOUT           0x8168
#define AR_WOW_KEEP_ALIVE_TIMEOUT       0x816c
#define AR_WOW_US_SCALAR                0x8170
#define AR_WOW_STATUS                   0x8174
#define AR_WOW_KEEP_ALIVE_DELAY         0x8178
#define AR_WOW_PATTERN_END_OF_PKT       0x817c
#define AR_WOW_PATTENR_OFFSET_MCH       0x8180
#define AR_WOW_PATTERN_OFFSET1          0x8184
#define AR_WOW_PATTERN_OFFSET2          0x8188
#define AR_WOW_KEEP_ALIVE_FAIL_DISABLE  0x8188

/*The above two registers share the same address. 
Which is a Bug in Swan. So patterns 4-7 doesnt 
have offset matching.*/
#define AR_WOW_KEEP_ALIVE_FRAME_DISABLE 0x818c
#define AR_WOW_TRANSMIT_BUFFER          0x7000

/* Wow Keep Alive Frames */
#define AR_WOW_KA_DESC_WORD2            0x7000
#define AR_WOW_KA_DESC_WORD3            0x7004
#define AR_WOW_KA_DESC_WORD4            0x7008
#define AR_WOW_KA_DESC_WORD5            0x700c
#define AR_WOW_KA_DATA_WORD0            0x7010
#define AR_WOW_KA_DATA_WORD1            0x7014
#define AR_WOW_KA_DATA_WORD2            0x7018
#define AR_WOW_KA_DATA_WORD3            0x701c
#define AR_WOW_KA_DATA_WORD4            0x7020
#define AR_WOW_KA_DATA_WORD5            0x7024

/* WoW Transmit Buffer for patterns */
#define AR_WOW_TB_PATTERN0              0x7100
#define AR_WOW_TB_PATTERN1              0x7200
#define AR_WOW_TB_PATTERN2              0x7300
#define AR_WOW_TB_PATTERN3              0x7400
#define AR_WOW_TB_PATTERN4              0x7500
#define AR_WOW_TB_PATTERN5              0x7600
#define AR_WOW_TB_PATTERN6              0x7700
#define AR_WOW_TB_PATTERN7              0x7800
#define AR_WOW_TB_MASK0                 0x7c00
#define AR_WOW_TB_MASK1                 0x7c20
#define AR_WOW_TB_MASK2                 0x7c40
#define AR_WOW_TB_MASK3                 0x7c60
#define AR_WOW_TB_MASK4                 0x7c80
#define AR_WOW_TB_MASK5                 0x7ca0
#define AR_WOW_TB_MASK6                 0x7cc0
#define AR_WOW_TB_MASK7                 0x7ce0

/* Wow values */
#define AR_WOW_PATTERN_EN               0x01
#define AR_WOW_MAGIC_PATTERN_EN         0x02
#define AR_WOW_MAGIC_PATTERN_EN_S       1
#define AR_WOW_STATUS_MASK              0x00000FFF
/* Swan WoW registers */
...
// LED control-related constants
#define AR_PCICFG_LEDCTL_S               5          /* LED control: bits 5..6 */
#define AR_PCICFG_LEDCTL                 0x00000060 /* Blink prop to filtered tx/rx */
#define AR_PCICFG_LEDCTL_NONE            0x0        /* STA is not associated or trying */
#define AR_PCICFG_LEDCTL_PEND            0x1        /* STA is trying to associate */
#define AR_PCICFG_LEDCTL_ASSOC           0x2        /* STA is associated */

#define AR_PCICFG_LEDPOWER_S             17         /* LED mode: bits 17..19 */
#define AR_PCICFG_LEDPOWER               0x000A0000 /* Power LED: bit 19=1, bit 17=<LED State> */
#define AR_PCICFG_LEDNETWORK_S           17         /* LED mode: bits 17..19 */
#define AR_PCICFG_LEDNETWORK             0x000C0000 /* Network LED: bit 19=1, bit 18=<LED State> */
#define AR_PCICFG_LEDMODE_S              17         /* LED mode: bits 17..19 */
#define AR_PCICFG_LEDMODE                0x000E0000 /* LED mode: bits 17..19 */
#define AR_PCICFG_LEDMODE_PROP           0x0        /* Blink prop to filtered tx/rx */
#define AR_PCICFG_LEDMODE_RPROP          0x1        /* Blink prop to unfiltered tx/rx */
#define AR_PCICFG_LEDMODE_SPLIT          0x2        /* Blink power for tx/net for rx */
#define AR_PCICFG_LEDMODE_RAND           0x3        /* Blink randomly */
#define AR_PCICFG_LEDMODE_POWER_OFF      0x4        /* Power LED OFF */
#define AR_PCICFG_LEDMODE_POWER_ON       0x5        /* Power LED ON   */
#define AR_PCICFG_LEDMODE_NETWORK_OFF    0x4        /* Network LED OFF */
#define AR_PCICFG_LEDMODE_NETWORK_ON     0x6        /* Network LED ON  */

#define AR_PCICFG_LEDBLINK_S             20         /* LED blink: bits 20..22 */
#define AR_PCICFG_LEDBLINK               0x00700000 /* LED blink: bits 20..22 - threshold select */

#define AR_PCICFG_LEDSLOW_S              23         /* LED slow: bit 23 */
#define AR_PCICFG_LEDSLOW                0x00800000 /* LED slow: bit 23 - LED state at slowest data rate */

#define AR_ENABLE_LED                    0x08080040 /* Receive enable */
...
#define AR_SREV_REVISION_MIN            0x0        /* lowest revision number */
#define AR_SREV_REVISION_MAX            0xF        /* highest revision number */
