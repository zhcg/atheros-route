 ...
 */
#ifndef ATH_SUPPORT_HT
#define ATH_SUPPORT_HT 1
#endif
...
#define ATH_SUPPORT_FORCE_PPM 1
#endif

#else
/*
 * if the HT support is off then turn off force ppm.
 */
#ifdef ATH_SUPPORT_FORCE_PPM
#undef ATH_SUPPORT_FORCE_PPM
#endif
