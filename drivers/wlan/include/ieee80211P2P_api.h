 ...
 *
 */
int wlan_p2p_set_channel(wlan_p2p_t  p2p_handle, bool in_listen_state, u_int32_t freq, u_int32_t req_id, u_int32_t channel_time);
 ...
 *
 */
#define wlan_p2p_set_channel(p2p_handle, in_listen_state, freq, req_id, channel_time)    (EINVAL)
