...
#ifdef CONFIG_MACH_AR7100_DUAL_VIR_PHY
...
ag7100_hw_setup(ag7100_mac_t *mac)
{
	...
	/*
	** NOTE
	** This was commented out to allow the interfaces to be reset independantly.  This hard reset will reset ALL MACs.
	** This may cause a problem with switching to various link configurations, this fix was added to fix another bug
	** but caused a problem in SPE.
