...
EXPORT_SYMBOL(athrmagpie_phy_read);
...
EXPORT_SYMBOL(athrmagpie_phy_write);
int
...
EXPORT_SYMBOL(athrmagpie_phy_is_up);
...
EXPORT_SYMBOL(athrmagpie_phy_speed);
int
...
EXPORT_SYMBOL(athrmagpie_phy_is_fdx);
void
...
EXPORT_SYMBOL(athrmagpie_phy_setup);
