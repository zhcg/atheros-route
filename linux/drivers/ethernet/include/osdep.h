...
#define ATHR_MAC_RESET_INIT_WORK(m, f)	INIT_WORK(&m->mac_reset_wqueue, (void *)f)
#define ATHR_MAC_RESET_TASK_ARG	struct work_struct *ws
#define ATHR_MAC_RESET_TASK_MAC()	                \
	athr_gmac_t *mac = (athr_gmac_t *)	\
		container_of(ws, athr_gmac_t, mac_reset_wqueue)
#else
#define ATHR_MAC_RESET_INIT_WORK(m, f)    /* Do nothing */ 
#endif 
