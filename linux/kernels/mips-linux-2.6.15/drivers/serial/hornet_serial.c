 ...
 *
 *  $Id: //depot/sw/releases/Aquila_9.2.0_U11/linux/kernels/mips-linux-2.6.15/drivers/serial/hornet_serial.c#1 $
 *
...
#define UART_NR	CONFIG_SERIAL_HORNET_NR_UARTS
...
#ifdef CONFIG_SERIAL_HORNET_CONSOLE
		/*
...
static int __init serial8250_init(void)
{
	...
	printk(KERN_INFO "Serial: 8250/16550 driver $Revision: #1 $ "
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Generic 8250/16x50 serial driver $Revision: #1 $");
