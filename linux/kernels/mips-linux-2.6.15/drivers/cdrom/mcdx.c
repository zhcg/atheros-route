...
static const char *mcdx_c_version
    = "$Id: //depot/sw/releases/Aquila_9.2.0_U11/linux/kernels/mips-linux-2.6.15/drivers/cdrom/mcdx.c#1 $";
#endif
...
static int __init mcdx_init(void)
{
	...
	xwarn("$Id: //depot/sw/releases/Aquila_9.2.0_U11/linux/kernels/mips-linux-2.6.15/drivers/cdrom/mcdx.c#1 $\n");
