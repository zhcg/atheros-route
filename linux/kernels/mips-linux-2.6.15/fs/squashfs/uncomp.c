...
/* $Id: //depot/sw/releases/Aquila_9.2.0_U11/linux/kernels/mips-linux-2.6.15/fs/squashfs/uncomp.c#1 $ */
...
MODULE_VERSION("$Id: //depot/sw/releases/Aquila_9.2.0_U11/linux/kernels/mips-linux-2.6.15/fs/squashfs/uncomp.c#1 $");
