...
#define READY_LED_OFF 0
#define READY_LED_ON 1
...
void ap_ready_led_on(void)
{
	...
	ar7240_gpio_out_val(AP_READY_LED_GPIO, READY_LED_ON);
#endif
}
...
{
#ifdef AP_READY_LED_GPIO
	ar7240_gpio_out_val(AP_READY_LED_GPIO, READY_LED_OFF);
#endif
}
...
#ifdef AP_READY_LED_GPIO
    ar7240_gpio_config_output(AP_READY_LED_GPIO);
    ap_ready_led_on();
#endif
