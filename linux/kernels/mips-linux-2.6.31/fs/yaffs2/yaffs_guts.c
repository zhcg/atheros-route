...
const char *yaffs_guts_c_version =
    "$Id: //depot/sw/releases/Aquila_9.2.0_U11/linux/kernels/mips-linux-2.6.31/fs/yaffs2/yaffs_guts.c#1 $";
...
static int yaffs_ScanBackwards(yaffs_Device *dev)
{
	...
	if (alloc_failed) {
		T(YAFFS_TRACE_ALWAYS, (TSTR("yaffs_ScanBackwards failed" TENDSTR)));
		return YAFFS_FAIL;
	}

	T(YAFFS_TRACE_ALWAYS, (TSTR("yaffs_ScanBackwards success" TENDSTR)));
