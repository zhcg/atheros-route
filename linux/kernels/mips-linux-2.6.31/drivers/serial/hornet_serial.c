 ...
 *
 *  $Id: //depot/sw/releases/Aquila_9.2.0_U11/linux/kernels/mips-linux-2.6.31/drivers/serial/hornet_serial.c#1 $
 *
...
static unsigned int nr_uarts = CONFIG_SERIAL_HORNET_NR_UARTS;
