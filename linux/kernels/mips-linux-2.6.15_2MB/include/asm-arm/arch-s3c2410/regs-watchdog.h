...
#define __ASM_ARCH_REGS_WATCHDOG_H "$Id: //depot/sw/releases/Aquila_9.2.0_U11/linux/kernels/mips-linux-2.6.15_2MB/include/asm-arm/arch-s3c2410/regs-watchdog.h#1 $"
