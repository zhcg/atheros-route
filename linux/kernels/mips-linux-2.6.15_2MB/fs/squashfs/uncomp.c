...
/* $Id: //depot/sw/releases/Aquila_9.2.0_U11/linux/kernels/mips-linux-2.6.15_2MB/fs/squashfs/uncomp.c#1 $ */
...
#ifdef __KERNEL__
        printk("******* %s: no lzma data found in the input stream \n", __func__);
#endif
	by_lzma = 0;
#ifndef CONFIG_SQUASHFS_LZMA
...
MODULE_VERSION("$Id: //depot/sw/releases/Aquila_9.2.0_U11/linux/kernels/mips-linux-2.6.15_2MB/fs/squashfs/uncomp.c#1 $");
