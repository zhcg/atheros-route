/* $Id: //depot/sw/releases/Aquila_9.2.0_U11/linux/kernels/mips-linux-2.6.15_2MB/drivers/net/cris/eth_v10.c#1 $
 *
			     ...
			     struct ethtool_drvinfo *info)
{
	...
	strncpy(info->version, "$Revision: #1 $", sizeof(info->version) - 1);
