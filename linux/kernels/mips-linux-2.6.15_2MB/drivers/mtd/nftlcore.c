...
/* $Id: //depot/sw/releases/Aquila_9.2.0_U11/linux/kernels/mips-linux-2.6.15_2MB/drivers/mtd/nftlcore.c#1 $ */
...
{
	printk(KERN_INFO "NFTL driver: nftlcore.c $Revision: #1 $, nftlmount.c %s\n", nftlmountrev);
