/* $Id: //depot/sw/releases/Aquila_9.2.0_U11/linux/kernels/mips-linux-2.6.15_2MB/drivers/isdn/hisax/telespci.c#1 $
 *
...
static const char *telespci_revision = "$Revision: #1 $";
