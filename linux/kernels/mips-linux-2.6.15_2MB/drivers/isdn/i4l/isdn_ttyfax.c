/* $Id: //depot/sw/releases/Aquila_9.2.0_U11/linux/kernels/mips-linux-2.6.15_2MB/drivers/isdn/i4l/isdn_ttyfax.c#1 $
 *
...
static char *isdn_tty_fax_revision = "$Revision: #1 $";
