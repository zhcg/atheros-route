 ...
 *
 *  $Id: //depot/sw/releases/Aquila_9.2.0_U11/linux/kernels/mips-linux-2.6.15_2MB/drivers/serial/clps711x.c#1 $
 *
 */
...
static int __init clps711xuart_init(void)
{
	...
	printk(KERN_INFO "Serial: CLPS711x driver $Revision: #1 $\n");
...
MODULE_DESCRIPTION("CLPS-711x generic serial driver $Revision: #1 $");
MODULE_LICENSE("GPL");
