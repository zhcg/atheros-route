 ...
 *
 *  $Id: //depot/sw/releases/Aquila_9.2.0_U11/linux/kernels/mips-linux-2.6.15_2MB/drivers/serial/21285.c#1 $
 */
...
static int __init serial21285_init(void)
{
	...
	printk(KERN_INFO "Serial: 21285 driver $Revision: #1 $\n");
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Intel Footbridge (21285) serial driver $Revision: #1 $");
