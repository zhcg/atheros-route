 ...
 *
 *  $Id: //depot/sw/releases/Aquila_9.2.0_U11/linux/kernels/mips-linux-2.6.15_2MB/drivers/serial/sa1100.c#1 $
 *
 */
...
static int __init sa1100_serial_init(void)
{
	...
	printk(KERN_INFO "Serial: SA11x0 driver $Revision: #1 $\n");
...
MODULE_DESCRIPTION("SA1100 generic serial port driver $Revision: #1 $");
MODULE_LICENSE("GPL");
