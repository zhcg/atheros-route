 ...
 *
 *  $Id: //depot/sw/releases/Aquila_9.2.0_U11/linux/kernels/mips-linux-2.6.15_2MB/drivers/serial/amba-pl010.c#1 $
 *
...
static int __init pl010_init(void)
{
	...
	printk(KERN_INFO "Serial: AMBA driver $Revision: #1 $\n");
...
MODULE_DESCRIPTION("ARM AMBA serial port driver $Revision: #1 $");
MODULE_LICENSE("GPL");
