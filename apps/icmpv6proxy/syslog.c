...
/*
** Writes the message 'FmtSt' with the parameters '...' to sysatlog.
** 'Serverity' is used for the sysatlog entry. For an 'Errno' value 
...
** also atlogged to 'stderr' and the program is finished with a call to 
** 'exit()'.
**
** If the 'Serverity' is more important then 'Log2Stderr' the message
** is atlogged to 'stderr'.
**          
*/
