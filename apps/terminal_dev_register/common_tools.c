...
int get_config()
{
	...
	//memcpy(g_config.step_log,"/var/terminal_dev_register/log/operation_steps/",strlen("/var/terminal_dev_register/log/operation_steps/"));
	memcpy(g_config.db,"/configure_backup/terminal_dev_register/db/terminal_base_db",strlen("/configure_backup/terminal_dev_register/db/terminal_base_db"));
	memcpy(g_config.center_phone,"62916698",strlen("62916698"));
	memcpy(g_config.center_ip,"210.14.156.93",strlen("210.14.156.93"));
	memcpy(g_config.center_port,"50128",strlen("50128"));
	memcpy(g_config.base_ip,"10.10.10.254",strlen("10.10.10.254"));
	memcpy(g_config.pad_ip,"10.10.10.100",strlen("10.10.10.100"));
	memcpy(g_config.pad_server_port,"7789",strlen("7789"));
	memcpy(g_config.pad_server_port2,"7799",strlen("7799"));
	memcpy(g_config.pad_client_port,"7788",strlen("7788"));
	g_config.total_timeout = 10;
	g_config.one_byte_timeout_sec = 5;
	g_config.one_byte_timeout_usec = 0;
	g_config.repeat = 5;
	memcpy(g_config.terminal_server_ip,"210.14.156.93",strlen("210.14.156.93"));
	memcpy(g_config.terminal_server_port,"50063",strlen("50063"));
	memcpy(g_config.local_server_port,"13435",strlen("13435"));
	memcpy(g_config.wan_check_name,"www.baidu.com",strlen("www.baidu.com"));
...
int get_cmd_out(char *cmd, char *buf, unsigned short buf_len)
{
	...
	gettimeofday(&tv, NULL);	
	sprintf(file_name, "/var/log/.%d%d", (int)tv.tv_sec, (int)tv.tv_usec);
