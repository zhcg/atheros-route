...
{
    &serial_pad_fd, &serial_5350_fd, &server_pad_fd, &server_base_fd,
    &network_flag, &g_cmd, &pad_cmd, 0,
    #if BOARDTYPE == 5350
    init_cmd_list, 
    #endif
    init_env, send_msg_to_pad, recv_msg_from_pad, network_settings,
    #if BOARDTYPE == 6410 
    send_msg_to_5350, recv_msg_from_5350, get_pppoe_state, route_config
    #elif BOARDTYPE == 5350
    get_wan_state, get_pppoe_state, config_route_take_effect, route_config, route_config2
    #elif BOARDTYPE == 9344
    get_wan_state,
    config_route_take_effect,
    route_config,
    route_config2,
    #endif
};
