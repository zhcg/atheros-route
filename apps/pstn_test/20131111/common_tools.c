...
struct class_common_tools common_tools = 
{
    ...
    make_serial_data_file, get_phone_stat, get_network_state, get_user_prompt, get_errno, get_list_MAC, get_MAC, get_wan_mac,
...
int get_config()
{
    ...
    {
        "STEP_LOG", "SERIAL_DATA_LOG", "DB", "OLD_ROUTE_CONFIG", 
        "PPPOE_STATE_FILE", "WAN_STATE_FILE", 
        "SERIAL_STC", "SERIAL_PAD", "SERIAL_5350", "SERIAL_STC_BAUD", 
        "SERIAL_PAD_BAUD", "SERIAL_5350_BAUD", "CENTERPHONE", "CENTERIP", 
        ...
        "ROUTE_REBOOT_TIME_SEC", "REPEAT", "TERMINAL_SERVER_IP", "TERMINAL_SERVER_PORT", "LOCAL_SERVER_PORT",        
    };
