...
//MS_FILTER_SET_SPEECH_CHANNEL
#define MS_FILTER_SET_SPEECH_CHANNEL	MS_FILTER_BASE_METHOD(28,int)
// MS_FILTER_SET_SI3000_REG
#define MS_FILTER_SET_SI3000_REG	MS_FILTER_BASE_METHOD(29,int)
