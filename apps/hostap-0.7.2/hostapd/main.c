...
{
/*Atheros driver has problem of reloading hostapd so we 
  are restarting hostapd when new security is configured 
  using wps.
*/
...
int main(int argc, char *argv[])
{
 ...
 out:
	...
	/* Restarting hostapd with new security settings 
	   configured through wps */
	if (reloading)
		execvp(argv[0], argv);
