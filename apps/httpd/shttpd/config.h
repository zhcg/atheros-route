...
#define	HTPASSWD	".htpasswd"	/* Passwords file name -- please keep same with
                                 * userman.h in cgi dir. maybe we can consider
                                 * make a symbol link with ln?
                                 */

#define	URI_MAX		(16384*2)	/* Default max request size	*/
#define	LISTENING_PORTS	"80"		/* Default listening ports	*/
#define	INDEX_FILES	"index.html,index.htm,index.php,index.cgi,info.shtml"
#define	CGI_EXT		"cgi,pl,php"	/* Default CGI extensions	*/
#define	SSI_EXT		"shtml,shtm"	/* Default SSI extensions	*/
#define	REALM		"Atheros_CTC_E8_Router"	/* Default authentication realm
                                             * please keep same with
                                             * userman.h in cgi dir. maybe we can consider
                                             * make a symbol link with ln?*/
