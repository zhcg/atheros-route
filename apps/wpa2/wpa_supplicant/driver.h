...
#ifdef CONFIG_TDLS
	int (*send_tdls_mgmt)(void *priv, u8* buf, u16 len);
	/**
	 * send_tdls_mgmt - for sending TDLS management packets
	 * @priv: private driver interface data
	 * @buf : TDLS SMK information to send to driver 
	 * @len : Size of the TDLS packet
	 *
	 * Returns: 0 on success, -1 on failure
	 *
...
#endif /* USE_INTEL_SDK */
#endif /* EAP_WPS */
	int (*set_etherdongle_lockmac) (void *priv, int);
};
