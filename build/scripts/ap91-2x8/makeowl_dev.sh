...
make BOARD_TYPE=ap91-2x8 BUILD_TYPE=squashfs toolchain_clean

# Generate a normal build
make BOARD_TYPE=ap91-2x8 BUILD_TYPE=squashfs

# make BOARD_TYPE=ap91-2x8 BUILD_TYPE=squashfs iptables_build
# make BOARD_TYPE=ap91-2x8 BUILD_TYPE=squashfs fusion_build
# make BOARD_TYPE=ap91-2x8 BUILD_TYPE=ram ram_build

# Nothing special in u-boot for fusion
# make BOARD_TYPE=ap91-2x8 uboot

# Generate NAT/Firewall image for AP91
make BOARD_TYPE=ap91-2x8 BUILD_TYPE=squashfs BUILD_CONFIG=_routing
