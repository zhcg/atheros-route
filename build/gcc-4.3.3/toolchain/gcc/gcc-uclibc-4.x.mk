...
$(GCC_DIR)/.unpacked: $(DL_DIR)/$(GCC_SOURCE)
	...
	$(CONFIG_UPDATE) $(@D)
	cd $(TOOL_BUILD_DIR)/gcc-4.3.3/libstdc++-v3/include/ext/; \
	cp ropeimpl.h tmp_ropeimpl.h; cp rope tmp_rope; chmod +w ropeimpl.h; chmod +w rope; \
	sed '{N;s/#include <ext\/numeric> \/\/ For power/#include <ext\/numeric> \/\/ For power\n#undef index/}' tmp_ropeimpl.h > ropeimpl.h; \
	sed '{N;s/#include <tr1\/functional>/#include <tr1\/functional>\n#undef index/}' tmp_rope > rope; 
	touch $@
